...
public class RoomList {
	...
	public RoomList(int SIZE){
		...
		rList[10].addNeighbor(new int[]{15,9,6});
		...
		rList[20]  = new Room(1200, 1390, "Milk Bar",20);
